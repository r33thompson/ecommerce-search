...
A minimal Spring Boot + Kotlin project that demonstrates the basics of an e-commerce **search retrieval and ranking** pipeline backed by Elasticsearch. Built as a learning exercise — small surface area, but enough moving parts to show how field boosting and fuzzy matching shape ranked results.
